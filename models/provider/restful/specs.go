...
type Specs struct {
	...
	Downloads SpecsDownload      `json:"downloads,omitempty" yaml:"downloads,omitempty" toml:"downloads,omitempty"`

	// RAMLs   []RAML  `json:"ramls,omitempty" yaml:"ramls,omitempty" toml:"ramls,omitempty"`
	// OpenAPIs []OpenAPI `json:"openapis,omitempty" yaml:"openapis,omitempty" toml:"openapis,omitempty"`
}

type SpecsDownload struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool `gorm:"column:debug" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
...
type SpecsRegistryAPIVersion struct {
	...
	OpenAPI        openapi.OpenAPI             `json:"openapi,omitempty" yaml:"openapi,omitempty" toml:"openapi,omitempty" `

	// OpenAPIParams is a list of parameters which the handler can accept
	// OpenAPIParams    []openapi.OpenApiParameter         `json:"openAPIParams,omitempty"`
	// OpenAPIResponses map[string]openapi.OpenApiResponse `json:"openAPIResponses,omitempty"`
}
