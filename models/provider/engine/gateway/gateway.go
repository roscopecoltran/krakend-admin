...
type Service struct {
	...
	Hosts            []Host        `mapstructure:"host" gorm:"many2many:gateway_service_hosts;" json:"host,omitempty" yaml:"host,omitempty" toml:"host,omitempty"`
...
type Backend2 struct {
	...
	Hosts   []Host   `mapstructure:"host" gorm:"many2many:gateway_backend_hosts;" json:"host,omitempty" yaml:"host,omitempty" toml:"host,omitempty"`
	Headers []Header `mapstructure:"header" storm:"header" json:"header" yaml:"header" toml:"header"`

	QueryStrings []QueryString   `mapstructure:"query_strings" storm:"query_strings" json:"query_strings" yaml:"query_strings" toml:"query_strings"`
	Parameters   []Parameter     `mapstructure:"parameters" storm:"parameters" json:"parameters" yaml:"parameters" toml:"parameters"`
	Blacklists   []Blacklist     `mapstructure:"blacklist" storm:"blacklist" json:"blacklist" yaml:"blacklist" toml:"blacklist"`
	Whitelists   []Whitelist     `mapstructure:"whitelist" storm:"whitelist" json:"whitelist" yaml:"whitelist" toml:"whitelist"`
	Paths        []provider.Path `mapstructure:"paths" storm:"paths" json:"paths" yaml:"paths" toml:"paths"`
	Mapping      []Mapping       `mapstructure:"mapping" storm:"mapping" json:"mapping" yaml:"mapping" toml:"mapping"`
	Holders      []Holder        `mapstructure:"holders" storm:"holders" json:"holders" yaml:"holders" toml:"holders"`
	URLKeys      []UrlKey        `mapstructure:"urls_keys_flat" storm:"urls_keys_flat" json:"urls_keys_flat" yaml:"urls_keys_flat" toml:"urls_keys_flat"`
...
type Backend struct {
	...
	Paths                    []provider.Path `gorm:"many2many:gateway_service_backend_paths;" json:"paths,omitempty" yaml:"paths,omitempty" toml:"paths,omitempty"`
}
